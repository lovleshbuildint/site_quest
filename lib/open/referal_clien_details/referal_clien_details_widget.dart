...
import 'referal_clien_details_model.dart';
...
class _ReferalClienDetailsWidgetState extends State<ReferalClienDetailsWidget> {
  late ReferalClienDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReferalClienDetailsModel());
