...
class DOADetailsstepFIRSTworddocCall {
  Future<ApiCallResponse> call({
    ...
    String? sitesourcedby = '',
    String? isOnSite = '',
    String? mgrName = 'mgrNameNull',
    String? mgrNo = 'mgrNoNull',
    int? iProjType,
    int? iSiteType,
    int? iTisType,
    int? iShopType,
    ...
    String? atmaval = 'atmavalNull',
    String? companyName = 'companyNameNull',
    String? employeeName = 'EmployeeNameNull',
...
class DOADetailsstepSECONDworddocCall {
  Future<ApiCallResponse> call({
    String? indentId = '',
    String? siteId = 'SiteIdnull',
    String? targetBank = 'TargetBankNull',
    String? district = '',
    String? centre = 'CentreNull',
    String? comment = 'CommentNull',
    String? lastModStamp = 'LastModStampNull',
    String? isHold = 'IsHoldNull',
    ...
    String? chequePercent = 'ChequePercentNull',
    String? address = '',
    String? landMark = '',
    String? contact1 = '',
    String? contact2 = '',
...
class DOADetailsstepTHIRDworddocCall {
  Future<ApiCallResponse> call({
    ...
    String? istage = 'IstageNull',
    String? iStageText = 'IStageTextNull',
    String? locationName = 'LocationNameNull',
    String? androidKey = 'AndroidKeyNull',
    String? rentalType = '',
    String? rent = '',
    ...
    String? fullDeposit = 'FullDepositnull',
    String? oneMonthDeposit = 'OneMonthDepositNull',
    String? balanceDeposit = 'BalanceDepositNull',
    String? totalDeposit = 'TotalDepositNull',
    String? rentEscalation = 'RentEscalationNull',
    String? escalationPeriod = '',
    String? agreementPeriod = '',
    String? isAdvance = 'isAdvance',
    String? totalAdvSec = 'TotalAdvSecNull',
    String? months = 'MonthsNull',
    String? isWB = 'isWBNull',
    String? companyName = 'companyNameNull',
    String? employeeName = 'EmployeeNameNull',
    String? contactNumber = 'ContactNumberNull',
    String? emailId = 'EmailIdNull',
    String? iindent = 'iindentNull',
    String? token = '',
  }) async {
    final ffApiRequestBody = '''
