                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              Expanded(
                                child: TextFormField(
                                  ...
                                  focusNode:
                                      _model.advanceRentAmountRENTFocusNode,
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller:
                                _model.rentEscaltionAdvanceValueController ??=
                                    FormFieldController<String>(
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model
                                    .escalationPeriodAdvanceValueController ??=
                                FormFieldController<String>(
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model
                                    .agreementPeriodsAdvanceValueController ??=
                                FormFieldController<String>(
                                ...
                                child: FlutterFlowRadioButton(
                                  ...
                                  onChanged: (val) async {
                                    ...
                                    _model.ebilling = functions.dropdown(
                                        _model.eBillingRentAdvanceValue!);
                                    setState(() {});
                                  },
                                  controller: _model
                                          .eBillingRentAdvanceValueController ??=
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model
                                    .rentFreePeriodsSecurityValueController ??=
                                FormFieldController<String>(
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller:
                                _model.securityDepositmonthValueController ??=
                                    FormFieldController<String>(
                            ...
                            onChanged: (val) async {
                              setState(
                                  () => _model.securityDepositmonthValue = val);
                              setState(() {
                                _model.totalSecurityDepositTextController
                                    ?.text = ((int.tryParse((_model
                                                .securityDepositmonthValue!)) ??
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model
                                    .intialAdvancemonthSecurityValueController ??=
                                FormFieldController<String>(
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .advanceSDAmountSecurityTextController,
                                          focusNode: _model
                                              .advanceSDAmountSecurityFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                            '_model.advanceSDAmountSecurityTextController',
                                            Duration(milliseconds: 1),
                                      ...
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          controller: _model
                                              .balanceSDAmountSecurityTextController,
                                          focusNode: _model
                                              .balanceSDAmountSecurityFocusNode,
                                          onChanged: (_) =>
                                              EasyDebounce.debounce(
                                            '_model.balanceSDAmountSecurityTextController',
                                            Duration(milliseconds: 1),
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model
                                    .rentEscalationPerSecurityValueController ??=
                                FormFieldController<String>(
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model
                                    .escalationPeriodSecurityValueController ??=
                                FormFieldController<String>(
                        ...
                        Padding(
                          ...
                          child: FlutterFlowDropDown<String>(
                            controller: _model
                                    .agreementPeriodsSecurityValueController ??=
                                FormFieldController<String>(
                            ...
                            children: [
                              Expanded(
                                child: FlutterFlowRadioButton(
                                  ...
                                  onChanged: (val) async {
                                    setState(() {});
                                    _model.ebillingrent = functions
                                        .dropdown(valueOrDefault<String>(
