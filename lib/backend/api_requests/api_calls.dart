...
class DOADetailssteponeCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${baseUrl}/DOADetails_step1/Token=${token}&iIndent=${iIndent}',
      callType: ApiCallType.GET,
      headers: {},
      params: {},
      returnBody: true,
...
class DOADetailsstepthreeCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${baseUrl}/DOADetails_step3/Token=${token}&iIndent=${iIndent}',
      callType: ApiCallType.GET,
      headers: {},
      params: {},
      returnBody: true,
...
class DOADetailsstepsevenCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${baseUrl}/DOADetails_step7/Token=${token}&iIndent=${iIndent}',
      callType: ApiCallType.GET,
      headers: {},
      params: {},
      returnBody: true,
