  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget!.updateData == true) {
        ...
        safeSetState(() {
          _model.cityssValueController1?.value = getJsonField(
            FFAppState().SiteDetailsIndent,
            r'''$.city''',
          ).toString().toString();
        });
                            ...
                            child: ListView(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller:
                                        _model.sitetypeValueController ??=
                                            FormFieldController<String>(null),
                                    options: (getJsonField(
                                      FFAppState().SiteType,
                                      r'''$..SiteTypeName''',
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller:
                                        _model.cashDeviceValueController ??=
                                            FormFieldController<String>(null),
                                    options: (getJsonField(
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller: _model
                                            .cashDeviceMovementValueController ??=
                                        FormFieldController<String>(null),
                                    options: (getJsonField(
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller: _model
                                            .strategyDropDwonValueController ??=
                                        FormFieldController<String>(null),
                                    options: (getJsonField(
                                      FFAppState().Strategy,
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model
                                        .distanceFromIndentsTextController,
                                    focusNode:
                                        _model.distanceFromIndentsFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.aTMExistingTextController,
                                    ...
                                    validator: _model
                                        .aTMExistingTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Padding(
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: _model
                                        .landMarksTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Padding(
                                ...
                                Padding(
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller:
                                        _model.rBICategoryValueController ??=
                                            FormFieldController<String>(null),
                                    options: (getJsonField(
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: _model
                                        .mangerNameTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Padding(
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.mangerNumberTextController,
                                ...
                                Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    future: SqGroup.getDepartmentWiseUserAPICall
                                        .call(
                                      department:
                                          FFAppState().department.toString(),
                                      token: FFAppState().Token,
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      ...
                                      return FlutterFlowDropDown<String>(
                                        ...
                                        onChanged: (val) async {
                                          safeSetState(() => _model
                                              .firstSiteVisitedByValue = val);
                                          _model.isitevisitedbynames =
                                              functions.checkIndexint(
                                                  firstSiteVisitedByGetDepartmentWiseUserAPIResponse
                                                      .jsonBody,
                                                  _model
                                                      .firstSiteVisitedByValue,
                                                  '-',
                                                  'UserName',
                                                  'iUser',
                                                  false);
                                ...
                                Padding(
                                  ...
                                  child: FutureBuilder<ApiCallResponse>(
                                    future:
                                        SqGroup.getSecondSiteVisitersCall.call(
                                      token: FFAppState().Token,
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      ...
                                      return FlutterFlowDropDown<String>(
                                        ...
                                        onChanged: (val) async {
                                          safeSetState(() => _model
                                              .secondSiteVisitedBYValue = val);
                                          _model.isecondsitevisitedbynames =
                                              functions.checkIndexint(
                                                  secondSiteVisitedBYGetSecondSiteVisitersResponse
                                                      .jsonBody,
                                                  _model
                                                      .secondSiteVisitedBYValue,
                                                  '-',
                                                  'UserName',
                                                  'iUser',
                                                  false);
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.updateDOAdetailsfirstwordsSites =
                                    ...
                                    locationName: null,
                                    distance: _model
                                        .distanceFromIndentsTextController.text,
                                  ...
                                  if ((String var1) {
                                    ...
                                    FFAppState().SiteDetailsIndent =
                                      ...
                                      'ATMExisting':
                                          _model.aTMExistingTextController.text,
                                      'Landmark':
                                          _model.landMarksTextController.text,
                                      'RBICategory': _model.rBICategoryValue,
                                      ...
                                      'MangerName':
                                          _model.mangerNameTextController.text,
                                      'MangerNumber': _model
                                          .mangerNumberTextController.text,
                                      'Duplicatesite':
                          ...
                          if (_model.stateDropdownValue != null &&
                            ...
                            FutureBuilder<ApiCallResponse>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return FlutterFlowDropDown<String>(
                                  controller: _model.cityssValueController2 ??=
                                      FormFieldController<String>(null),
                                  options: (getJsonField(
                                    cityssCitiesAPIforStatenDistResponse
                                        .jsonBody,
                      ...
                      if (_model.stateDropdownValue != null &&
                        ...
                        FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FlutterFlowDropDown<String>(
                              controller: _model.cityssValueController3 ??=
                                  FormFieldController<String>(null),
                              options: (getJsonField(
                                cityssCitiesAPIforStatenDistResponse.jsonBody,
                                r'''$.Cities..City''',
                                true,
                              ) as List)
                                  .map<String>((s) => s.toString())
                                  .toList()!,
                              onChanged: (val) async {
                                safeSetState(() => _model.cityssValue3 = val);
