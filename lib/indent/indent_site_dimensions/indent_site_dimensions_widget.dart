                          ...
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model
                                        .sitedimentionsModel.radioButtonValue ==
                                    null) {
                                  return;
                                }
                                if (_model.sitedimentionsModel
                                        .lShapeSingageValue ==
                                    null) {
                                  await showDialog(
                                    context: context,
                                ...
                                if (_model.sitedimentionsModel.vsatValue ==
                                    null) {
                                  await showDialog(
                                    context: context,
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Alert'),
                                        content: Text('Please Select VSAT'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Alert'),
                                        content: Text(
                                            'Please Select Power Availability'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
